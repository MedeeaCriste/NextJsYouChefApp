        ...
        <div className='bg-white relative mt-[5%] container mx-auto z-30 p-8'>
            ...
            <div className='flex flex-col items-center'>
                ...
                <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 justify-center'>
                    ...
                    <ModalElement src={`${imagesPath}quick.jpg`} func={handleClick} text="Quick & Easy" val="quick" selectedVal={selectedVal}/>
                    <ModalElement src={`${imagesPath}vegetarian.jpg`} func={handleClick} text="Vegetarian" val="vegetarian" selectedVal={selectedVal}/>
                    <ModalElement src={`${imagesPath}lunch.jpg`} func={handleClick} text="Lunch" val="lunch" selectedVal={selectedVal}/>
                </div>
                <Link href={{
                    pathname: "/results",
                    query: { 
